...
<body>
    ...
    <div class="container">
        ...
        <div class="message">
            <p><i class="fas fa-book-reader"></i> Oops! The page you're looking for doesn't exist. Perhaps it was removed or you typed the wrong URL. Let's get back to learning!</p>
        </div>

        <!-- Countdown Timer -->
        <div class="countdown">
            <p>Redirecting to your dashboard in <span id="timer">5</span> seconds...</p>
        </div>
