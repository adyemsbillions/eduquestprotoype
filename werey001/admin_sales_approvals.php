    ...
    <div class="container">
        ...
        <div>
            ...
            <div class="request-card">
                <img src="/dashboard/<?php echo htmlspecialchars($request['receipt_path']); ?>" alt="Receipt"
                    class="receipt-image">
                <div>
                    <p><strong>User:</strong> <?php echo htmlspecialchars($request['username']); ?></p>
                    <p><strong>Requested:</strong>
                        <?php echo date('F j, Y, g:i a', strtotime($request['requested_at'])); ?></p>
                </div>
                <div>
                    <form method="POST">
            ...
            <div class="approved-card">
                <div>
                    ...
                    <p><strong>Approved On:</strong>
                        <?php echo date('F j, Y, g:i a', strtotime($approved['updated_at'])); ?></p>
            ...
            <div class="suspended-card">
                <div>
                    ...
                    <p><strong>Suspended On:</strong>
                        <?php echo date('F j, Y, g:i a', strtotime($suspended['updated_at'])); ?></p>
                </div>
                <form method="POST">
