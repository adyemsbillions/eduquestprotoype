...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const profileChart = new Chart(ctx, {
        ...
        data: {
            labels: ['Total Students', 'Completed Profiles', 'Incomplete Profiles'],
            datasets: [{
...
<head>
    ...
    <style>
        ...
        .space-y-3 > * + * {
            margin-top: 12px; /* 3 * 4px base unit */
        }
        .md\:space-y-0 {
            @media (min-width: 768px) {
                .space-y-3 > * + * {
        ...
        <div class="notification blue">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
                <div>
                    ...
                    <b>You have <?php echo $new_users_count; ?> new <?php echo $new_users_count === 1 ? 'user' : 'users'; ?> in the last 24hrs</b>
                </div>
...
.image-cell .image { display: inline-block; }
.icon { font-size: 20px; }
.actions-cell .buttons { display: flex; gap: 5px; }
