...
<head>
    ...
    <style>
        ...
        * {
        ...
        .message.success { background: rgba(40, 167, 69, 0.1); color: var(--success); border: 1px solid var(--success); }
        .message.error { background: rgba(220, 53, 69, 0.1); color: var(--error); border: 1px solid var(--error); }
        ...
        .group-item:hover { transform: translateY(-3px); box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); }
        .group-item h3 { color: var(--primary); font-size: 22px; margin-bottom: 15px; font-weight: 600; }
        .group-item form { display: flex; align-items: center; gap: 15px; margin: 15px 0; }
        .group-item label { font-size: 16px; cursor: pointer; }
        ...
        .group-item input[type="submit"]:hover { background: var(--primary-hover); transform: translateY(-2px); }
        .group-item p { color: #666; font-size: 14px; font-style: italic; }
        .no-groups { text-align: center; padding: 20px; color: #777; font-size: 16px; }

        @media (max-width: 768px) {
            .container { padding: 20px; }
            .group-item form { flex-direction: column; align-items: flex-start; }
            .group-item input[type="submit"] { width: 100%; }
        }
    </style>
</head>
<body>
