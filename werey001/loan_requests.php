            ...
            <?php while ($loan_request = $loan_requests->fetch_assoc()): ?>
                <div class="loan-history-item">
                    <div>
                        ...
                        <strong>Account Number:</strong> <?php echo htmlspecialchars($loan_request['account_number']); ?><br>
                        ...
                        <strong>Next Payment Date:</strong> <?php echo htmlspecialchars($loan_request['next_payment_date']); ?><br>
