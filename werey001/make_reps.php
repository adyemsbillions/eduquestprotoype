...
<head>
    ...
    <style>
        ...
        .approve-link { background-color: #28a745; color: white; }
        .suspend-link { background-color: #dc3545; color: white; }
        .action-links a:hover { opacity: 0.9; }
        .no-action { color: #666; font-style: italic; }
    </style>
</head>
<body>
    <div class="container">
            ...
            <tbody>
                ...
                if ($usersResult->num_rows > 0) {
                    while ($user = $usersResult->fetch_assoc()) {
                        $statusClass = $user['reps_status'] === 'approved' ? 'status-approved' : 
                                     ($user['reps_status'] === 'suspended' ? 'status-suspended' : 'status-pending');
