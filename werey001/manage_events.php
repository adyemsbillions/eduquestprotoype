    ...
    <div class="container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="event_description" name="event_description" rows="4" required><?php echo $event_description; ?></textarea>
            </div>

            <div class="form-group">
                <label for="event_date">Event Date and Time</label>
                <input type="datetime-local" id="event_date" name="event_date" value="<?php echo date('Y-m-d\TH:i', strtotime($event_date)); ?>" required>
            </div>
        ...
        <div class="event-list">
            <?php while ($event = $result_events->fetch_assoc()): ?>
                <div class="event-item">
                    ...
                    <a href="manage_events.php?event_id=<?php echo $event['event_id']; ?>" class="btn btn-edit">Edit Event</a>
                </div>
            <?php endwhile; ?>
        </div>
    </div>
