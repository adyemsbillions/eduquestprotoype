        ...
        <div class="form-section">
            ...
            <form method="POST">
                ...
                <select name="user_id" id="user_id" required>
                    ...
                    <option value="<?php echo $user['id']; ?>"><?php echo htmlspecialchars($user['username']); ?> (ID:
                        <?php echo $user['id']; ?>)</option>
                    <?php endwhile; ?>
                </select>
        ...
        <div class="list-section">
            ...
            <ul class="allowed-list">
                ...
                <li class="allowed-item">
                    <span><?php echo htmlspecialchars($allowed['username']); ?> (ID:
                        <?php echo $allowed['user_id']; ?>)</span>
                    <form method="POST"
                        onsubmit="return confirm('Remove <?php echo htmlspecialchars($allowed['username']); ?> from allowed posters?');">
